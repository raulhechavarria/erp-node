...
-- Started on 2018-10-06 22:39:36
...
SELECT pg_catalog.setval('customer_id_seq', 48, true);
...
SELECT pg_catalog.setval('orders_id_seq', 110, true);
...
SELECT pg_catalog.setval('shippingaddress_id_seq', 29, true);
...
INSERT INTO customer (id, name, phone, email, streetandnumber, city, state, zipcode, country) VALUES (34, 'MAGAYA', '78630870547', 'GIANNIESTEVEZ81@GMAIL.COMp', '8261 nw 5 terra, 336', 'miami', 'Florida', '33126', 'United States');
...
INSERT INTO customer (id, name, phone, email, streetandnumber, city, state, zipcode, country) VALUES (48, 'Furia', '1236549877', 'ria@casual.com', 'bdcb', 'bcb', 'cjkhwkk', '12345', 'usa');
...
INSERT INTO orders (id, numberorder, date, idcustomer, paymenttype) VALUES (109, '2018-425', '2018-10-11', 3, 'Credit Card');
INSERT INTO orders (id, numberorder, date, idcustomer, paymenttype) VALUES (110, '2018-639', '2018-10-18', 3, 'Check');
...
INSERT INTO ordersproduct (idproduct, idorders, count) VALUES (23, 109, NULL);
INSERT INTO ordersproduct (idproduct, idorders, count) VALUES (22, 109, NULL);
INSERT INTO ordersproduct (idproduct, idorders, count) VALUES (2, 110, NULL);
INSERT INTO ordersproduct (idproduct, idorders, count) VALUES (24, 110, NULL);
...
INSERT INTO product (id, name, weight, price, description) VALUES (22, 'microcamera', 16, 79, 'compatible');
...
INSERT INTO shippingaddress (id, streetandnumber, city, state, zipcode, country, idcustomer) VALUES (26, '196 E 41ST ST', 'HIALEAH', 'FL', '33013', 'United States', 32);
INSERT INTO shippingaddress (id, streetandnumber, city, state, zipcode, country, idcustomer) VALUES (29, '8261 nw 5 terra, 336', 'miami', 'Florida', '33126', 'United States', 32);
...
-- Dependencies: 1600 1600
-- Name: emaileunique; Type: CONSTRAINT; Schema: public; Owner: rhp; Tablespace: 
--
...
-- Dependencies: 1600 1600
-- Name: phoneunique; Type: CONSTRAINT; Schema: public; Owner: rhp; Tablespace: 
--
...
-- Dependencies: 1598
-- Name: fki_customeraddresss; Type: INDEX; Schema: public; Owner: rhp; Tablespace: 
--
...
-- Name: customeraddresss; Type: FK CONSTRAINT; Schema: public; Owner: rhp
--
...
-- Completed on 2018-10-06 22:39:37
